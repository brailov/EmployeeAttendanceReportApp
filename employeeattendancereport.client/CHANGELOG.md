...
- Create Angular project with ng: `ng new employeeattendancereport.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employeeattendancereport.client.esproj`).
